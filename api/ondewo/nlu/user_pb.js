...
proto.ondewo.nlu.User.prototype.getUserProfilePicture_asB64 = function () {
	return /** @type {string} */ (jspb.Message.bytesAsB64(this.getUserProfilePicture()));
};
...
proto.ondewo.nlu.User.prototype.getUserProfilePicture_asU8 = function () {
	return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getUserProfilePicture()));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.ondewo.nlu.GetUserPreferencesResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				userName: jspb.Message.getFieldWithDefault(msg, 1, ''),
				keyValuePairsList: jspb.Message.toObjectList(
					msg.getKeyValuePairsList(),
					ondewo_nlu_common_pb.KeyValuePair.toObject,
					includeInstance
				),
...
proto.ondewo.nlu.GetUserPreferencesResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(2, f, ondewo_nlu_common_pb.KeyValuePair.serializeBinaryToWriter);
	}
