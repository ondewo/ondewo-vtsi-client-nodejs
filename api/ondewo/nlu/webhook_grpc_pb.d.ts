...
interface IWebhookService_ICreateSessionEntityType
	extends grpc.MethodDefinition<
		ondewo_nlu_webhook_pb.CreateSessionEntityTypeRequest,
		ondewo_nlu_webhook_pb.SessionEntityType
	> {
...
interface IWebhookService_IUpdateSessionEntityType
	extends grpc.MethodDefinition<
		ondewo_nlu_webhook_pb.UpdateSessionEntityTypeRequest,
		ondewo_nlu_webhook_pb.SessionEntityType
	> {
...
interface IWebhookService_IDeleteSessionEntityType
	extends grpc.MethodDefinition<ondewo_nlu_webhook_pb.DeleteSessionEntityTypeRequest, google_protobuf_empty_pb.Empty> {
...
export interface IWebhookServer {
	...
	createSessionEntityType: grpc.handleUnaryCall<
		ondewo_nlu_webhook_pb.CreateSessionEntityTypeRequest,
		ondewo_nlu_webhook_pb.SessionEntityType
	>;
	updateSessionEntityType: grpc.handleUnaryCall<
		ondewo_nlu_webhook_pb.UpdateSessionEntityTypeRequest,
		ondewo_nlu_webhook_pb.SessionEntityType
	>;
	deleteSessionEntityType: grpc.handleUnaryCall<
		ondewo_nlu_webhook_pb.DeleteSessionEntityTypeRequest,
...
export interface IWebhookClient {
	...
	createSessionEntityType(
		...
		callback: (error: grpc.ServiceError | null, response: ondewo_nlu_webhook_pb.SessionEntityType) => void
	): grpc.ClientUnaryCall;
	createSessionEntityType(
		request: ondewo_nlu_webhook_pb.CreateSessionEntityTypeRequest,
		metadata: grpc.Metadata,
...
export class WebhookClient extends grpc.Client implements IWebhookClient {
	...
	public createSessionEntityType(
		request: ondewo_nlu_webhook_pb.CreateSessionEntityTypeRequest,
		callback: (error: grpc.ServiceError | null, response: ondewo_nlu_webhook_pb.SessionEntityType) => void
	): grpc.ClientUnaryCall;
	public createSessionEntityType(
	...
	public updateSessionEntityType(
		request: ondewo_nlu_webhook_pb.UpdateSessionEntityTypeRequest,
		callback: (error: grpc.ServiceError | null, response: ondewo_nlu_webhook_pb.SessionEntityType) => void
	): grpc.ClientUnaryCall;
	public updateSessionEntityType(
	...
	public deleteSessionEntityType(
		request: ondewo_nlu_webhook_pb.DeleteSessionEntityTypeRequest,
		callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void
	): grpc.ClientUnaryCall;
	public deleteSessionEntityType(
