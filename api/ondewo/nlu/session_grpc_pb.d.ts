...
interface ISessionsService_IDetectIntent
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.DetectIntentRequest, ondewo_nlu_session_pb.DetectIntentResponse> {
...
interface ISessionsService_IStreamingDetectIntent
	extends grpc.MethodDefinition<
		ondewo_nlu_session_pb.StreamingDetectIntentRequest,
		ondewo_nlu_session_pb.StreamingDetectIntentResponse
	> {
...
interface ISessionsService_IListSessions
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.ListSessionsRequest, ondewo_nlu_session_pb.ListSessionsResponse> {
...
interface ISessionsService_IGetSession
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.GetSessionRequest, ondewo_nlu_session_pb.Session> {
...
interface ISessionsService_ICreateSession
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.CreateSessionRequest, ondewo_nlu_session_pb.Session> {
...
interface ISessionsService_ITrackSessionStep
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.TrackSessionStepRequest, ondewo_nlu_session_pb.Session> {
...
interface ISessionsService_IDeleteSession
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.DeleteSessionRequest, google_protobuf_empty_pb.Empty> {
...
interface ISessionsService_IListSessionLabels
	extends grpc.MethodDefinition<
...
interface ISessionsService_IGetSessionReview
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.GetSessionReviewRequest, ondewo_nlu_session_pb.SessionReview> {
...
interface ISessionsService_IGetLatestSessionReview
	extends grpc.MethodDefinition<
		ondewo_nlu_session_pb.GetLatestSessionReviewRequest,
...
interface ISessionsService_ICreateSessionReview
	extends grpc.MethodDefinition<ondewo_nlu_session_pb.CreateSessionReviewRequest, ondewo_nlu_session_pb.SessionReview> {
...
export interface ISessionsServer {
	detectIntent: grpc.handleUnaryCall<
		ondewo_nlu_session_pb.DetectIntentRequest,
		ondewo_nlu_session_pb.DetectIntentResponse
	>;
	streamingDetectIntent: grpc.handleBidiStreamingCall<
		ondewo_nlu_session_pb.StreamingDetectIntentRequest,
		ondewo_nlu_session_pb.StreamingDetectIntentResponse
	>;
	listSessions: grpc.handleUnaryCall<
		ondewo_nlu_session_pb.ListSessionsRequest,
		ondewo_nlu_session_pb.ListSessionsResponse
	>;
	...
	listSessionLabels: grpc.handleUnaryCall<
		ondewo_nlu_session_pb.ListSessionLabelsRequest,
		ondewo_nlu_session_pb.ListSessionLabelsResponse
	>;
	...
	listSessionReviews: grpc.handleUnaryCall<
		...
		ondewo_nlu_session_pb.ListSessionReviewsResponse
	>;
	getSessionReview: grpc.handleUnaryCall<
		ondewo_nlu_session_pb.GetSessionReviewRequest,
		ondewo_nlu_session_pb.SessionReview
	>;
	getLatestSessionReview: grpc.handleUnaryCall<
		ondewo_nlu_session_pb.GetLatestSessionReviewRequest,
		ondewo_nlu_session_pb.SessionReview
	>;
...
export interface ISessionsClient {
	detectIntent(
		...
		callback: (error: grpc.ServiceError | null, response: ondewo_nlu_session_pb.DetectIntentResponse) => void
	...
	streamingDetectIntent(): grpc.ClientDuplexStream<
		ondewo_nlu_session_pb.StreamingDetectIntentRequest,
		ondewo_nlu_session_pb.StreamingDetectIntentResponse
	>;
	...
	listSessions(
		...
		callback: (error: grpc.ServiceError | null, response: ondewo_nlu_session_pb.ListSessionsResponse) => void
	): grpc.ClientUnaryCall;
	listSessions(
		request: ondewo_nlu_session_pb.ListSessionsRequest,
		metadata: grpc.Metadata,
