...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListSessionLabelsOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListLanguageCodesOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListMatchedIntentsOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListMatchedEntityTypesOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListIdentifiedUserIdsOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListInputContextsOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListOutputContextsOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListAccountIdsOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListPropertyIdsOfAllSessionsRequest.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.ListDatastreamIdsOfAllSessionsRequest.displayName =
		...
		var f,
			obj = {
				...
				transcriptionsList: jspb.Message.toObjectList(
					...
					proto.ondewo.nlu.S2tTranscription.toObject,
					includeInstance
				)
			};
...
proto.ondewo.nlu.QueryParameters.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(14, f, proto.ondewo.nlu.S2tTranscription.serializeBinaryToWriter);
	}
};
	...
	proto.ondewo.nlu.SessionStep.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				audioFileResourcesList: jspb.Message.toObjectList(
					msg.getAudioFileResourcesList(),
					proto.ondewo.nlu.AudioFileResource.toObject,
					includeInstance
				)
			};
...
proto.ondewo.nlu.SessionStep.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(2, f, proto.ondewo.nlu.DetectIntentRequest.serializeBinaryToWriter);
	}
	f = message.getDetectIntentResponse();
	if (f != null) {
		writer.writeMessage(3, f, proto.ondewo.nlu.DetectIntentResponse.serializeBinaryToWriter);
	}
	f = message.getContextsList();
	if (f.length > 0) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(10, f, proto.ondewo.nlu.AudioFileResource.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.ListSessionsRequest.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(6, f, google_protobuf_field_mask_pb.FieldMask.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.SessionFilter.serializeBinaryToWriter = function (message, writer) {
	...
	if (f !== 0.0) {
		writer.writeFloat(41, f);
	}
	f = message.getPlatformsList();
	if (f.length > 0) {
		writer.writePackedEnum(42, f);
	}
	f = message.getAccountIdsList();
	if (f.length > 0) {
		writer.writeRepeatedString(43, f);
	}
	...
	if (f.length > 0) {
		writer.writeRepeatedString(45, f);
	}
	...
	proto.ondewo.nlu.SessionInfo.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				parentCommentList: jspb.Message.toObjectList(
					msg.getParentCommentList(),
					ondewo_nlu_common_pb.Comment.toObject,
					includeInstance
				)
			};
...
proto.ondewo.nlu.SessionInfo.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getPlatformsList();
	if (f.length > 0) {
		writer.writePackedEnum(26, f);
	}
	f = message.getAccountIdsList();
	if (f.length > 0) {
		writer.writeRepeatedString(27, f);
	}
	f = message.getPropertyIdsList();
	if (f.length > 0) {
	...
	f = message.getDatastreamIdsList();
	if (f.length > 0) {
		writer.writeRepeatedString(29, f);
	}
	f = message.getOriginIdsList();
	if (f.length > 0) {
		writer.writeRepeatedString(30, f);
	}
	f = message.getIdentifiedUserIdsList();
	if (f.length > 0) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(33, f, ondewo_nlu_common_pb.Comment.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.SessionReviewStep.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(4, f, proto.ondewo.nlu.DetectedIntent.serializeBinaryToWriter);
	}
	f = message.getContextsList();
	if (f.length > 0) {
	...
	f = message.getAudioFileResourcesList();
	if (f.length > 0) {
		writer.writeRepeatedMessage(14, f, proto.ondewo.nlu.AudioFileResource.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.ListSessionLabelsOfAllSessionsRequest.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getSessionFilter();
	if (f != null) {
		writer.writeMessage(2, f, proto.ondewo.nlu.SessionFilter.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.AddSessionCommentRequest.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(2, f, ondewo_nlu_common_pb.Comment.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.AddSessionCommentRequest.prototype.getComment = function () {
	return /** @type{?proto.ondewo.nlu.Comment} */ (jspb.Message.getWrapperField(this, ondewo_nlu_common_pb.Comment, 2));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.ondewo.nlu.ListSessionCommentsResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				commentList: jspb.Message.toObjectList(
					msg.getCommentList(),
					ondewo_nlu_common_pb.Comment.toObject,
					includeInstance
				),
...
proto.ondewo.nlu.ListSessionCommentsResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, ondewo_nlu_common_pb.Comment.serializeBinaryToWriter);
	}
	f = message.getPageToken();
	if (f.length > 0) {
		writer.writeString(2, f);
...
proto.ondewo.nlu.AudioFileResource.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getTranscriptionsList();
	if (f.length > 0) {
		writer.writeRepeatedMessage(7, f, proto.ondewo.nlu.S2tTranscription.serializeBinaryToWriter);
	}
	f = message.getCreatedAt();
	if (f != null) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.ondewo.nlu.GetAudioFilesResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				audioFilesList: jspb.Message.toObjectList(
					msg.getAudioFilesList(),
					proto.ondewo.nlu.AudioFileResource.toObject,
					includeInstance
				),
...
proto.ondewo.nlu.GetAudioFilesResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.ondewo.nlu.AudioFileResource.serializeBinaryToWriter);
	}
...
proto.ondewo.nlu.AddAudioFilesRequest.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getAudioFileResourcesList();
	if (f.length > 0) {
		writer.writeRepeatedMessage(3, f, proto.ondewo.nlu.AudioFileResource.serializeBinaryToWriter);
	}
};
