...
interface IEntityTypesService_IGetEntityType extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.GetEntityTypeRequest, ondewo_nlu_entity_type_pb.EntityType> {
...
interface IEntityTypesService_ICreateEntityType extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.CreateEntityTypeRequest, ondewo_nlu_entity_type_pb.EntityType> {
...
interface IEntityTypesService_IUpdateEntityType extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.UpdateEntityTypeRequest, ondewo_nlu_entity_type_pb.EntityType> {
...
interface IEntityTypesService_IDeleteEntityType extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.DeleteEntityTypeRequest, google_protobuf_empty_pb.Empty> {
...
interface IEntityTypesService_IGetEntity extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.GetEntityRequest, ondewo_nlu_entity_type_pb.EntityType.Entity> {
...
interface IEntityTypesService_ICreateEntity extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.CreateEntityRequest, ondewo_nlu_entity_type_pb.EntityType.Entity> {
...
interface IEntityTypesService_IUpdateEntity extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.UpdateEntityRequest, ondewo_nlu_entity_type_pb.EntityType.Entity> {
...
interface IEntityTypesService_IDeleteEntity extends grpc.MethodDefinition<ondewo_nlu_entity_type_pb.DeleteEntityRequest, ondewo_nlu_entity_type_pb.DeleteEntityStatus> {
...
export interface IEntityTypesServer {
    listEntityTypes: grpc.handleUnaryCall<ondewo_nlu_entity_type_pb.ListEntityTypesRequest, ondewo_nlu_entity_type_pb.ListEntityTypesResponse>;
    getEntityType: grpc.handleUnaryCall<ondewo_nlu_entity_type_pb.GetEntityTypeRequest, ondewo_nlu_entity_type_pb.EntityType>;
    ...
    getEntity: grpc.handleUnaryCall<ondewo_nlu_entity_type_pb.GetEntityRequest, ondewo_nlu_entity_type_pb.EntityType.Entity>;
    createEntity: grpc.handleUnaryCall<ondewo_nlu_entity_type_pb.CreateEntityRequest, ondewo_nlu_entity_type_pb.EntityType.Entity>;
    updateEntity: grpc.handleUnaryCall<ondewo_nlu_entity_type_pb.UpdateEntityRequest, ondewo_nlu_entity_type_pb.EntityType.Entity>;
    deleteEntity: grpc.handleUnaryCall<ondewo_nlu_entity_type_pb.DeleteEntityRequest, ondewo_nlu_entity_type_pb.DeleteEntityStatus>;
...
export interface IEntityTypesClient {
    listEntityTypes(request: ondewo_nlu_entity_type_pb.ListEntityTypesRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.ListEntityTypesResponse) => void): grpc.ClientUnaryCall;
    listEntityTypes(request: ondewo_nlu_entity_type_pb.ListEntityTypesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.ListEntityTypesResponse) => void): grpc.ClientUnaryCall;
    listEntityTypes(request: ondewo_nlu_entity_type_pb.ListEntityTypesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.ListEntityTypesResponse) => void): grpc.ClientUnaryCall;
    getEntityType(request: ondewo_nlu_entity_type_pb.GetEntityTypeRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    getEntityType(request: ondewo_nlu_entity_type_pb.GetEntityTypeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    getEntityType(request: ondewo_nlu_entity_type_pb.GetEntityTypeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    createEntityType(request: ondewo_nlu_entity_type_pb.CreateEntityTypeRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    createEntityType(request: ondewo_nlu_entity_type_pb.CreateEntityTypeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    createEntityType(request: ondewo_nlu_entity_type_pb.CreateEntityTypeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    updateEntityType(request: ondewo_nlu_entity_type_pb.UpdateEntityTypeRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    updateEntityType(request: ondewo_nlu_entity_type_pb.UpdateEntityTypeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    updateEntityType(request: ondewo_nlu_entity_type_pb.UpdateEntityTypeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    ...
    getEntity(request: ondewo_nlu_entity_type_pb.GetEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    getEntity(request: ondewo_nlu_entity_type_pb.GetEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    getEntity(request: ondewo_nlu_entity_type_pb.GetEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    createEntity(request: ondewo_nlu_entity_type_pb.CreateEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    createEntity(request: ondewo_nlu_entity_type_pb.CreateEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    createEntity(request: ondewo_nlu_entity_type_pb.CreateEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    updateEntity(request: ondewo_nlu_entity_type_pb.UpdateEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    updateEntity(request: ondewo_nlu_entity_type_pb.UpdateEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    updateEntity(request: ondewo_nlu_entity_type_pb.UpdateEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    deleteEntity(request: ondewo_nlu_entity_type_pb.DeleteEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.DeleteEntityStatus) => void): grpc.ClientUnaryCall;
    deleteEntity(request: ondewo_nlu_entity_type_pb.DeleteEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.DeleteEntityStatus) => void): grpc.ClientUnaryCall;
    deleteEntity(request: ondewo_nlu_entity_type_pb.DeleteEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.DeleteEntityStatus) => void): grpc.ClientUnaryCall;
...
export class EntityTypesClient extends grpc.Client implements IEntityTypesClient {
    ...
    public listEntityTypes(request: ondewo_nlu_entity_type_pb.ListEntityTypesRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.ListEntityTypesResponse) => void): grpc.ClientUnaryCall;
    public listEntityTypes(request: ondewo_nlu_entity_type_pb.ListEntityTypesRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.ListEntityTypesResponse) => void): grpc.ClientUnaryCall;
    public listEntityTypes(request: ondewo_nlu_entity_type_pb.ListEntityTypesRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.ListEntityTypesResponse) => void): grpc.ClientUnaryCall;
    public getEntityType(request: ondewo_nlu_entity_type_pb.GetEntityTypeRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public getEntityType(request: ondewo_nlu_entity_type_pb.GetEntityTypeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public getEntityType(request: ondewo_nlu_entity_type_pb.GetEntityTypeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public createEntityType(request: ondewo_nlu_entity_type_pb.CreateEntityTypeRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public createEntityType(request: ondewo_nlu_entity_type_pb.CreateEntityTypeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public createEntityType(request: ondewo_nlu_entity_type_pb.CreateEntityTypeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public updateEntityType(request: ondewo_nlu_entity_type_pb.UpdateEntityTypeRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public updateEntityType(request: ondewo_nlu_entity_type_pb.UpdateEntityTypeRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    public updateEntityType(request: ondewo_nlu_entity_type_pb.UpdateEntityTypeRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType) => void): grpc.ClientUnaryCall;
    ...
    public getEntity(request: ondewo_nlu_entity_type_pb.GetEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public getEntity(request: ondewo_nlu_entity_type_pb.GetEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public getEntity(request: ondewo_nlu_entity_type_pb.GetEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public createEntity(request: ondewo_nlu_entity_type_pb.CreateEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public createEntity(request: ondewo_nlu_entity_type_pb.CreateEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public createEntity(request: ondewo_nlu_entity_type_pb.CreateEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public updateEntity(request: ondewo_nlu_entity_type_pb.UpdateEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public updateEntity(request: ondewo_nlu_entity_type_pb.UpdateEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public updateEntity(request: ondewo_nlu_entity_type_pb.UpdateEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.EntityType.Entity) => void): grpc.ClientUnaryCall;
    public deleteEntity(request: ondewo_nlu_entity_type_pb.DeleteEntityRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.DeleteEntityStatus) => void): grpc.ClientUnaryCall;
    public deleteEntity(request: ondewo_nlu_entity_type_pb.DeleteEntityRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.DeleteEntityStatus) => void): grpc.ClientUnaryCall;
    public deleteEntity(request: ondewo_nlu_entity_type_pb.DeleteEntityRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_entity_type_pb.DeleteEntityStatus) => void): grpc.ClientUnaryCall;
