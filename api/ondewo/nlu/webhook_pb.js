	...
	proto.ondewo.nlu.WebhookResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				sessionEntityTypesList: jspb.Message.toObjectList(
					msg.getSessionEntityTypesList(),
					proto.ondewo.nlu.SessionEntityType.toObject,
					includeInstance
				)
			};
...
proto.ondewo.nlu.WebhookResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(10, f, proto.ondewo.nlu.SessionEntityType.serializeBinaryToWriter);
	}
};
		...
		var f,
			obj = {
				...
				entitiesList: jspb.Message.toObjectList(
					msg.getEntitiesList(),
					ondewo_nlu_entity_type_pb.EntityType.Entity.toObject,
					includeInstance
				)
			};
...
proto.ondewo.nlu.SessionEntityType.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(3, f, ondewo_nlu_entity_type_pb.EntityType.Entity.serializeBinaryToWriter);
	}
};
...
proto.ondewo.nlu.SessionEntityType.prototype.getEntityOverrideMode = function () {
	return /** @type {!proto.ondewo.nlu.SessionEntityType.EntityOverrideMode} */ (
...
proto.ondewo.nlu.ListSessionEntityTypesResponse.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getSessionEntityTypesList();
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.ondewo.nlu.SessionEntityType.serializeBinaryToWriter);
	}
	...
	proto.ondewo.nlu.CreateSessionEntityTypeRequest.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				parent: jspb.Message.getFieldWithDefault(msg, 1, ''),
				sessionEntityType:
					(f = msg.getSessionEntityType()) && proto.ondewo.nlu.SessionEntityType.toObject(includeInstance, f),
...
proto.ondewo.nlu.CreateSessionEntityTypeRequest.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(2, f, proto.ondewo.nlu.SessionEntityType.serializeBinaryToWriter);
	}
...
proto.ondewo.nlu.UpdateSessionEntityTypeRequest.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getSessionEntityType();
	if (f != null) {
		writer.writeMessage(1, f, proto.ondewo.nlu.SessionEntityType.serializeBinaryToWriter);
	}
