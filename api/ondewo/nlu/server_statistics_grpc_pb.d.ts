...
interface IServerStatisticsService_IGetProjectCount
	extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, ondewo_nlu_common_pb.StatResponse> {
...
interface IServerStatisticsService_IGetUserProjectCount
	extends grpc.MethodDefinition<
		ondewo_nlu_server_statistics_pb.GetUserProjectCountRequest,
...
interface IServerStatisticsService_IGetUserCount
	extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, ondewo_nlu_common_pb.StatResponse> {
...
export interface IServerStatisticsServer {
	...
	getUserProjectCount: grpc.handleUnaryCall<
		ondewo_nlu_server_statistics_pb.GetUserProjectCountRequest,
		ondewo_nlu_common_pb.StatResponse
	>;
