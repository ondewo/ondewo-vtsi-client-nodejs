...
interface IIntentsService_IBatchUpdateIntents extends grpc.MethodDefinition<ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, ondewo_nlu_operations_pb.Operation> {
...
export interface IIntentsServer {
    ...
    batchUpdateIntents: grpc.handleUnaryCall<ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, ondewo_nlu_operations_pb.Operation>;
...
export interface IIntentsClient {
    ...
    batchUpdateIntents(request: ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    batchUpdateIntents(request: ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    batchUpdateIntents(request: ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_operations_pb.Operation) => void): grpc.ClientUnaryCall;
...
export class IntentsClient extends grpc.Client implements IIntentsClient {
    ...
    public batchUpdateIntents(request: ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    public batchUpdateIntents(request: ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_operations_pb.Operation) => void): grpc.ClientUnaryCall;
    public batchUpdateIntents(request: ondewo_nlu_intent_pb.BatchUpdateIntentsRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_nlu_operations_pb.Operation) => void): grpc.ClientUnaryCall;
