...
proto.ondewo.nlu.SetNotificationsFlaggedStatusRequest = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.ondewo.nlu.SetNotificationsFlaggedStatusRequest.repeatedFields_,
		null
	);
};
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.ondewo.nlu.SetNotificationsFlaggedStatusRequest.displayName =
...
proto.ondewo.nlu.SetNotificationsReadStatusRequest = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.ondewo.nlu.SetNotificationsReadStatusRequest.repeatedFields_,
		null
	);
};
		...
		var f,
			obj = {
				...
				notificationFlaggedTimestamp:
					(f = msg.getNotificationFlaggedTimestamp()) &&
				...
				notificationReadTimestamp:
					(f = msg.getNotificationReadTimestamp()) &&
					google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
		...
		var f,
			obj = {
				notificationList: jspb.Message.toObjectList(
					...
					proto.ondewo.nlu.Notification.toObject,
					includeInstance
				)
			};
...
proto.ondewo.nlu.AddNotificationsRequest.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.ondewo.nlu.Notification.serializeBinaryToWriter);
	}
};
	...
	while (reader.nextField()) {
		...
		switch (field) {
			case 1:
				...
				break;
			case 2:
				var values = /** @type {!Array<!proto.ondewo.nlu.NotificationOrigin>} */ (
				...
				break;
			case 3:
				var values = /** @type {!Array<!proto.ondewo.nlu.NotificationVisibility>} */ (
					reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]
				);
				for (var i = 0; i < values.length; i++) {
				...
				break;
			case 4:
				var values = /** @type {!Array<!proto.ondewo.nlu.NotificationFlaggedStatus>} */ (
					reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]
				);
				for (var i = 0; i < values.length; i++) {
				...
				break;
			case 5:
				var values = /** @type {!Array<!proto.ondewo.nlu.NotificationReadStatus>} */ (
					reader.isDelimited() ? reader.readPackedEnum() : [reader.readEnum()]
				);
				for (var i = 0; i < values.length; i++) {
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.ondewo.nlu.ListNotificationsRequest.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				notificationFilter:
					(f = msg.getNotificationFilter()) && proto.ondewo.nlu.NotificationFilter.toObject(includeInstance, f),
...
proto.ondewo.nlu.ListNotificationsRequest.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(1, f, proto.ondewo.nlu.NotificationFilter.serializeBinaryToWriter);
	}
...
proto.ondewo.nlu.KeyValuePair.prototype.getValueCase = function () {
	return /** @type {proto.ondewo.nlu.KeyValuePair.ValueCase} */ (
		jspb.Message.computeOneofCase(this, proto.ondewo.nlu.KeyValuePair.oneofGroups_[0])
	);
};
