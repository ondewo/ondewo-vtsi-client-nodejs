...
interface IText2SpeechService_IBatchSynthesize extends grpc.MethodDefinition<ondewo_t2s_text_to_speech_pb.BatchSynthesizeRequest, ondewo_t2s_text_to_speech_pb.BatchSynthesizeResponse> {
...
interface ICustomPhonemizersService_IGetCustomPhonemizer extends grpc.MethodDefinition<ondewo_t2s_text_to_speech_pb.PhonemizerId, ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto> {
...
interface ICustomPhonemizersService_ICreateCustomPhonemizer extends grpc.MethodDefinition<ondewo_t2s_text_to_speech_pb.CreateCustomPhonemizerRequest, ondewo_t2s_text_to_speech_pb.PhonemizerId> {
...
interface ICustomPhonemizersService_IDeleteCustomPhonemizer extends grpc.MethodDefinition<ondewo_t2s_text_to_speech_pb.PhonemizerId, google_protobuf_empty_pb.Empty> {
...
interface ICustomPhonemizersService_IUpdateCustomPhonemizer extends grpc.MethodDefinition<ondewo_t2s_text_to_speech_pb.UpdateCustomPhonemizerRequest, ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto> {
...
interface ICustomPhonemizersService_IListCustomPhonemizer extends grpc.MethodDefinition<ondewo_t2s_text_to_speech_pb.ListCustomPhonemizerRequest, ondewo_t2s_text_to_speech_pb.ListCustomPhonemizerResponse> {
...
export interface ICustomPhonemizersClient {
    getCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    getCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    getCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    createCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.CreateCustomPhonemizerRequest, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.PhonemizerId) => void): grpc.ClientUnaryCall;
    createCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.CreateCustomPhonemizerRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.PhonemizerId) => void): grpc.ClientUnaryCall;
    createCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.CreateCustomPhonemizerRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.PhonemizerId) => void): grpc.ClientUnaryCall;
    deleteCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    deleteCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    deleteCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    updateCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.UpdateCustomPhonemizerRequest, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    updateCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.UpdateCustomPhonemizerRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    updateCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.UpdateCustomPhonemizerRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
...
export class CustomPhonemizersClient extends grpc.Client implements ICustomPhonemizersClient {
    constructor(address: string, credentials: grpc.ChannelCredentials, options?: object);
    public getCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    public getCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    public getCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    public createCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.CreateCustomPhonemizerRequest, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.PhonemizerId) => void): grpc.ClientUnaryCall;
    public createCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.CreateCustomPhonemizerRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.PhonemizerId) => void): grpc.ClientUnaryCall;
    public createCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.CreateCustomPhonemizerRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.PhonemizerId) => void): grpc.ClientUnaryCall;
    public deleteCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public deleteCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public deleteCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.PhonemizerId, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: google_protobuf_empty_pb.Empty) => void): grpc.ClientUnaryCall;
    public updateCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.UpdateCustomPhonemizerRequest, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    public updateCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.UpdateCustomPhonemizerRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
    public updateCustomPhonemizer(request: ondewo_t2s_text_to_speech_pb.UpdateCustomPhonemizerRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: ondewo_t2s_text_to_speech_pb.CustomPhonemizerProto) => void): grpc.ClientUnaryCall;
