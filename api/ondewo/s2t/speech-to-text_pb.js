...
proto.ondewo.s2t.Silero.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    minSpeechDurationMs: jspb.Message.getFloatingPointFieldWithDefault(msg, 4, 0.0),
    minSilenceDurationMs: jspb.Message.getFloatingPointFieldWithDefault(msg, 5, 0.0),
    speechPadMs: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0.0),
    tritonServerHost: jspb.Message.getFieldWithDefault(msg, 7, ""),
    tritonServerPort: jspb.Message.getFieldWithDefault(msg, 8, 0)
  };
...
proto.ondewo.s2t.WespeakerTsd.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    similarityThreshold: jspb.Message.getFloatingPointFieldWithDefault(msg, 5, 0.0),
    minAudioLength: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0.0),
