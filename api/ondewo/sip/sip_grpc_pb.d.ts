...
interface ISipService_IStartSession
	extends grpc.MethodDefinition<ondewo_sip_sip_pb.StartSessionRequest, google_protobuf_empty_pb.Empty> {
...
interface ISipService_IStartCall
	extends grpc.MethodDefinition<ondewo_sip_sip_pb.StartCallRequest, google_protobuf_empty_pb.Empty> {
...
interface ISipService_IEndCall
	extends grpc.MethodDefinition<ondewo_sip_sip_pb.EndCallRequest, google_protobuf_empty_pb.Empty> {
...
interface ISipService_ITransferCall
	extends grpc.MethodDefinition<ondewo_sip_sip_pb.TransferCallRequest, google_protobuf_empty_pb.Empty> {
...
interface ISipService_IRegisterAccount
	extends grpc.MethodDefinition<ondewo_sip_sip_pb.RegisterAccountRequest, google_protobuf_empty_pb.Empty> {
...
interface ISipService_IPlayWavFiles
	extends grpc.MethodDefinition<ondewo_sip_sip_pb.PlayWavFilesRequest, google_protobuf_empty_pb.Empty> {
